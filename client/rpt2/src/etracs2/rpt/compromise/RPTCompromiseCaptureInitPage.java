...
public class RPTCompromiseCaptureInitPage extends javax.swing.JPanel {
    
    /** Creates new form RPTCompromiseInitPage */
    public RPTCompromiseCaptureInitPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Compromise Agreement (Capture)");
        ...
        xNumberField4.setCaption("Start Year ");
        xNumberField4.setCaptionWidth(120);
        xNumberField4.setFieldType(Integer.class);
        xNumberField4.setName("entity.info.startyear");
        ...
        xNumberField7.setName("entity.info.endyear");
