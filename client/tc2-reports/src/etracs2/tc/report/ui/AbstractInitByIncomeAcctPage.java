 ...
 * @author  user
 */
public class AbstractInitByIncomeAcctPage extends javax.swing.JPanel {
    
    /**
     * Creates new form AbstractOfCollectionInitPage
     */
    public AbstractInitByIncomeAcctPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xLookupField1.setCaption("Income Account");
        xLookupField1.setCaptionWidth(110);
        xLookupField1.setExpression("#{accttitle}");
        xLookupField1.setHandler("lookupIncomeAccount");
        xLookupField1.setIndex(-10);
        xLookupField1.setName("incomeacct");
