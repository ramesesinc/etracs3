...
abstract class AbstractCollectionController
{
    ...
    def getReportName() { return 'etracs2/tc/report/receipt/af51/af51.jasper' }
    
    def getSubReportList() { 
        return [
            new SubReport('AF51Item', 'etracs2/tc/report/receipt/af51/af51item.jasper')
        ]  as SubReport[]
    }
    
    def getDetailReportName() { return 'etracs2/tc/report/receipt/af51detail/af51detail.jasper' }
    
    def getDetailSubReportList() { 
        return [
            new SubReport('ITEM', 'etracs2/tc/report/receipt/af51detail/af51detailitem.jasper')
        ]  as SubReport[]
    }
    ...
    def report = [
        ...
        getSubReports : { return getSubReportList() },
    ...
    def detailReport = [
        ...
        getSubReports : { return getDetailSubReportList() },
        getReportData : { return entity } ,
    ] as ReportModel;
