...
package etracs2.entity.master.ui;
 ...
 * @author  windhel
 */
@StyleSheet("etracs2/ctc/master/ui/ProfessionPage.style")
public class ContactTypePage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xTitledBorder3.setTitle("Profession Information");
        formPanel1.setBorder(xTitledBorder3);
        xTextField2.setCaption("Contact Type");
        xTextField2.setCaptionWidth(100);
        xTextField2.setDepends(new String[] {"selectedItem"});
        xTextField2.setName("entity.objid");
